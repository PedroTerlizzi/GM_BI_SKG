...
SELECT
    ...
    CAST(
        CASE s.SeriesID
            WHEN 1 THEN CASE l.LabelID WHEN 2 THEN t.TotalInicial WHEN 3 THEN (t.TotalInicial + t.TotalEntradas) ELSE 0 END
    ...
    CAST(
        CASE s.SeriesID
            WHEN 1 THEN 0
            WHEN 2 THEN CASE l.LabelID WHEN 1 THEN t.Inicial325 WHEN 2 THEN t.Entradas325 WHEN 3 THEN t.Salidas325 WHEN 4 THEN t.Final325 ELSE 0 END
            WHEN 3 THEN CASE l.LabelID WHEN 1 THEN t.Inicial327 WHEN 2 THEN t.Entradas327 WHEN 3 THEN t.Salidas327 WHEN 4 THEN t.Final327 ELSE 0 END
            WHEN 4 THEN CASE l.LabelID WHEN 1 THEN t.Inicial326 WHEN 2 THEN t.Entradas326 WHEN 3 THEN t.Salidas326 WHEN 4 THEN t.Final326 ELSE 0 END
            WHEN 5 THEN CASE l.LabelID WHEN 1 THEN t.Inicial324 WHEN 2 THEN t.Entradas324 WHEN 3 THEN t.Salidas324 WHEN 4 THEN t.Final324 ELSE 0 END
            WHEN 6 THEN CASE l.LabelID WHEN 1 THEN t.Inicial323 WHEN 2 THEN t.Entradas323 WHEN 3 THEN t.Salidas323 WHEN 4 THEN t.Final323 ELSE 0 END
            ELSE 0
        END
