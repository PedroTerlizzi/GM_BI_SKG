    ...
    CAST(
        CASE s.SeriesID
            WHEN 1 THEN
                CASE l.LabelID
                    WHEN 1 THEN 0
                    WHEN 2 THEN a.InventarioInicial
                    WHEN 3 THEN a.InventarioFinal
                    WHEN 4 THEN 0
                    ELSE 0
                END
            WHEN 2 THEN
                CASE l.LabelID
                    WHEN 1 THEN a.InventarioInicial
                    WHEN 2 THEN a.Entradas
                    WHEN 3 THEN ABS(a.Salidas)
                    WHEN 4 THEN a.InventarioFinal
                    ELSE 0
                END
            ELSE 0
        END
