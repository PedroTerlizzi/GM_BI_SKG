...
FROM (
    SELECT 1 AS LabelID, 'Entradas Manuales' AS LabelTitle
    UNION ALL SELECT 2, 'Otras entradas'
    UNION ALL SELECT 3, 'Salidas por Ventas'
    UNION ALL SELECT 4, 'Otras Salidas'
) lbl
CROSS JOIN (
