...
FROM (
    ...
    UNION ALL SELECT 2003, 2, 'Atributo', '3', 'Comision'
    UNION ALL SELECT 2004, 2, 'Atributo', '4', 'Duracion Std'
    UNION ALL SELECT 2005, 2, 'Atributo', '5', 'Exclusivo Dr.'
    UNION ALL SELECT 2006, 2, 'Atributo', '6', 'Croquis'
) t
